...
class EncoderDecoderAttractor(nn.Module):
    ...
    def forward_core(self, xs, zeros):
        ...
        zeros = [self.dec0_dropout(z) for z in zeros]
    ...
    def forward(self, xs, n_speakers):
        ...
        # attractors, zlens = self.forward_core(xs, zeros)
        ...
        attractors = [att[:(att.shape[0] - 1)] for att in attractors]
